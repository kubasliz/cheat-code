...
export function Hero() {
  ...
  return (
    <div className="flex flex-row items-center justify-center py-20 h-screen md:h-auto relative w-full mb-20">
      <div className="max-w-7xl mx-auto w-full relative overflow-hidden h-full md:h-[40rem] px-4">
        <div>
          ...
          <p className="text-center text-base md:text-lg font-normal max-w-md mt-2 mx-auto">
            No <span className="text-blue-600 font-semibold">cheats</span>, just creativity and
            passion
          </p>
        </div>
